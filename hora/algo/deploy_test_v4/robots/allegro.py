...
class Allegro(object):
    ...
    #     This only applies for the envelop named hand command.
    #     You can set the envelop torque before or after commanding the envelop grasp.

    #     :param torque: Desired torque, between 0 and 1. Values outside this range are clamped.
    #     :return: True.
    #     """
